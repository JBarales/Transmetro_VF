...
<div class="col-md-3 col-lg-2 sidebar bg-dark text-white">
    <div class="p-3">
        ...
        <?php if ($_SESSION['rol'] === 'admin'): ?>
            ...
            <!-- Submenú de Reportes -->
            <a class="text-white text-decoration-none d-flex justify-content-between align-items-center mb-2" data-bs-toggle="collapse" href="#submenuReportes" role="button" aria-expanded="false" aria-controls="submenuReportes">
                Reportes
                <span class="bi bi-chevron-down"></span>
            </a>
            <div class="collapse ps-3" id="submenuReportes">
                <a href="reporte_empleados.php" class="text-white text-decoration-none d-block mb-1">Empleados Activos</a>
            </div>


            
            <!-- Submenú de Reportes -->
            <a class="text-white text-decoration-none d-flex justify-content-between align-items-center mb-2" data-bs-toggle="collapse" href="#submenuReportes" role="button" aria-expanded="<?= (isset($submenu_abierto) && $submenu_abierto === 'reportes') ? 'true' : 'false' ?>" aria-controls="submenuReportes">
                Reportes
                <span class="bi <?= (isset($submenu_abierto) && $submenu_abierto === 'reportes') ? 'bi-chevron-up' : 'bi-chevron-down' ?>"></span>
            </a>
            <div class="collapse ps-3 <?= (isset($submenu_abierto) && $submenu_abierto === 'reportes') ? 'show' : '' ?>" id="submenuReportes">
                <a href="reporte_empleados.php" class="text-white text-decoration-none d-block mb-1">Reporte de Empleados</a>
            </div>
