...
// Consulta: cantidad de buses por línea
...
<body>
<div class="row g-0">
    <!-- Sidebar básico para usuarios -->
    <div class="col-md-3 col-lg-2 sidebar">
        <div class="p-3">
            <h5 class="text-white">Panel Usuario</h5>
            <hr class="text-white">
            <p class="text-white">Hola, <strong><?= htmlspecialchars($_SESSION['usuario']) ?></strong></p>
            <a href="vista_lineas_usuario.php" class="text-white text-decoration-none d-block mb-2">Ver Líneas</a>
            <a href="estaciones.php" class="text-white text-decoration-none d-block mb-2">Ver Estaciones</a>
            <a href="buses_en_linea.php" class="text-white text-decoration-none d-block mb-2">Buses en Línea</a>
            <a href="buses_en_parqueo.php" class="text-white text-decoration-none d-block mb-2">Buses en Parqueo</a>
            <a href="registrar_viaje.php" class="text-white text-decoration-none d-block mb-2">Registrar Viaje</a>
            <a href="viajes.php" class="text-white text-decoration-none d-block mb-2">Mis Viajes</a>
    ...
    <div class="col-md-9 col-lg-10 p-4">
        ...
        <p>Usa el menú lateral para navegar por las opciones disponibles.</p>

        <div class="alert alert-info mt-4">
            Este es un panel exclusivo para usuarios normales. Aquí puedes ver las líneas, estaciones disponibles y registrar tus viajes.
        </div>

        <!-- Tabla: cantidad de buses por línea -->
        <div class="mt-4">
