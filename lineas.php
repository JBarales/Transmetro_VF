...
<div class="row g-0">
    ...
    <div class="col-md-9 col-lg-10 p-4">
        ...
        <a href="registrar_linea.php" class="btn btn-success mb-3">Registrar Nueva Línea</a>
                ...
                <?php foreach ($lineas as $l): ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="editar_linea.php?id=<?= urlencode($l['ID_Linea']) ?>" class="btn btn-warning btn-sm">Editar</a>
                            <a href="eliminar_linea.php?id=<?= urlencode($l['ID_Linea']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro?')">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
